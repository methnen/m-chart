...
function SheetTabs() {
  ...
  const multiSheetTypes = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useMemo)(() => {
    const types = window.wp?.hooks ? wp.hooks.applyFilters('m_chart.multi_sheet_types', [...MULTI_SHEET_TYPES]) : [...MULTI_SHEET_TYPES];
