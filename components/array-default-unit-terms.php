...
return array(
	esc_html__( 'Time', 'm-chart' )            => array(
		...
		esc_html__( 'Days', 'm-chart' ),
		esc_html__( 'Weeks', 'm-chart' ),
		esc_html__( 'Months', 'm-chart' ),
		esc_html__( 'Quarter', 'm-chart' ),
	...
	esc_html__( 'Length', 'm-chart' )          => array(
		...
		esc_html__( 'Mile', 'm-chart' ),
		esc_html__( 'Millimeter', 'm-chart' ),
