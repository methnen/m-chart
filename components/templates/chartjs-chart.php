...
<div id="m-chart-container-<?php echo absint( $post_id ); ?>-<?php echo absint( $this->instance ); ?>"
	...
	<canvas id="m-chart-<?php echo absint( $post_id ); ?>-<?php echo absint( $this->instance ); ?>" role="img"
		class="m-chart" height="<?php echo absint( $height ); ?>" <?php echo $width; ?>></canvas>
</div>
<script type="text/javascript">
var m_chart_container_<?php echo absint( $post_id ); ?>_<?php echo absint( $this->instance ); ?>_canvas = document
	.getElementById('m-chart-<?php echo absint( $post_id ); ?>-<?php echo absint( $this->instance ); ?>').getContext(
		'2d');
			...
			function() {
				...
				var source = {
					onComplete: function() {
						...
						if (false ===
							m_chart_chartjs_<?php echo absint( $post_id ); ?>_<?php echo absint( $this->instance ); ?>
							.render_1) {
							return;
						}
						...
						$('.m-chart').trigger({
							type: 'render_done',
							post_id: m_chart_chartjs_<?php echo absint( $post_id ); ?>_<?php echo absint( $this->instance ); ?>
								.post_id,
							instance: m_chart_chartjs_<?php echo absint( $post_id ); ?>_<?php echo absint( $this->instance ); ?>
								.instance
						});
					}
				}
